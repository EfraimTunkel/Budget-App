...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const toggleButtons = () => {
    const isProfileVisible = (profileSection && !profileSection.classList.contains('hidden')) ||
                            (walletsSection && walletsSection.classList.contains('open')); // Check for 'open'
    if (isProfileVisible) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('profile-card-wallets').addEventListener('click', (e) => {
    e.preventDefault();
    document.getElementById('wallet-page-section').classList.add('open');
    loadWalletPage();
  });
  
  document.getElementById('wallet-back-btn').addEventListener('click', () => {
    document.getElementById('wallet-page-section').classList.remove('open');
    showSection('profile-section'); // Ensure Profile section is visible
  });
